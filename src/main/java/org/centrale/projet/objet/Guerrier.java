...
public class Guerrier extends Personnage implements Combattant{
     ...
     */
    public Guerrier(int ptVie, int pourcentageAtt, int pourcentagePar, int degAtt, Point2D pos, String nom, int ptMana, int pourcentageMag, int pourcentageResistMag, int degMag, int distAttMax, int ptPar){
    ...
    /**
     *
     * @param s la chaine de caractères dont on va extraire les caractéristique de Guerrier
     */
    public Guerrier(String s){
    ...
    /**
     * Le guerrier combat une Creature
     * @param c
     */
    ...
    /**
     * Affichage des attributs de guerrier
     */
    public void affiche(){
        System.out.println("Creature type Guerrier");
        ...
        System.out.println("Il a: "+this.getPtPar()+" PtPar");
